import { Button, ButtonGroup, Card, Elevation, Icon, Tag, Intent } from "@blueprintjs/core";
...
export default class RosterDetailsPanel extends React.Component<RosterDetailsPanelProps> {
  ...
  render() {
    ...
    if (shrunk) {
        return (
            <div className="roster-details-panel -shrunk" onClick={() => this.props.onSelectRoster(roster)}>
        ...
        <div className="roster-details-panel">
            <Card interactive={false} elevation={Elevation.TWO} className="details-panel-card">
                    ...
                    <div className="panel-section">
                        ...
                        <div className="leadership-section">
                            ...
                            <div className="section-items">
                                <Tag intent={Intent.SUCCESS} minimal={true} className="section-tag">{roster.results.wins}</Tag>
                                <Tag intent={Intent.DANGER} minimal={true} className="section-tag">{roster.results.losses}</Tag>
                            </div>
                        </div>
                        <div className="leadership-section">
                            <div className="section-label">
                            ...
                            <div className="section-items">
                                <Tag intent={Intent.PRIMARY} minimal={true} className="section-tag">{roster.results.finish}</Tag>
                            </div>
                        </div>
                    </div>
                    <div className="panel-section">
                        ...
                        <div className="leadership-section">
                            ...
                            <div className="section-items">
                                {roster.captains.map(captain => <RosterUserAvatar playerId={captain} player={PLAYERS[captain]} rosterId={roster.id} hideBadge={true} />)}
                            </div>
                        </div>
                        <div className="leadership-section">
                            <div className="section-label">
                            ...
                            <div className="section-items">
                                {roster.coaches.map(coach => <RosterUserAvatar playerId={coach} player={PLAYERS[coach]} rosterId={roster.id} hideBadge={true} />)}
                            </div>
                        </div>
                    </div>
                ...
                <ButtonGroup className="panel-footer">
                    <Button className="footer-button" text="USAU Roster" icon={<Icon icon={IconNames.GLOBE} iconSize={10} />} onClick={() => this.openLinkInNewTab(roster.link)}/>
