...
export const TOURNAMENTS_2016: TournamentList = {
  ...
  "2016-esc": {
    ...
    link:
      "http://play.usaultimate.org/events/TCT-Elite-Select-Challenge-2016-Oshadega-Invite/schedule/Women/Club-Women/",
    result: 10,
    sanctioned: true,
  ...
  "2016-chc": {
    ...
    link:
      "http://play.usaultimate.org/events/Heavyweights-2016/schedule/Women/Club-Women/",
    result: 2,
    sanctioned: true,
  ...
  "2016-sfi": {
    ...
    link:
      "http://play.usaultimate.org/events/TCT-Select-Flight-Invite-2016/schedule/Women/Club-Women/",
    result: 2,
    sanctioned: true,
  ...
  "2016-sectionals": {
    ...
    link:
      "http://play.usaultimate.org/events/East-Plains-Womens-Sectionals-2016/schedule/Women/Club-Women/",
    result: 1,
    sanctioned: true,
  ...
  "2016-regionals": {
    ...
    link:
      "http://play.usaultimate.org/events/Great-Lakes-Womens-Regionals-2016/schedule/Women/Club-Women/",
    result: 1,
    sanctioned: true,
